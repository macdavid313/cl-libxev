...
#+allegro (ff:def-foreign-type xev-threadpool-batch (:array :unsigned-char 32))
#-allegro (cffi:defctype xev-threadpool-batch (:array :unsigned-char 32))
#+allegro (ff:def-foreign-type xev-threadpool-task (:array :unsigned-char 32))
#-allegro (cffi:defctype xev-threadpool-task (:array :unsigned-char 32))
